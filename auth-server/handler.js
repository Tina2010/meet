...
const credentials = {
  ...
  redirect_uris: ["https://Tina2010.github.io/meet"],
  javascript_origins: ["https://Tina2010.github.io", "http://localhost:3000"],
};
...
module.exports.getAccessToken = async (event) => {
  //creation of OAuthClient => needed in every serverless function
  const oAuth2Client = new google.auth.OAuth2(
    client_id,
    client_secret,
    redirect_uris[0]
